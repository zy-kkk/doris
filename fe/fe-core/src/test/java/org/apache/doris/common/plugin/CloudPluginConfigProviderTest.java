...
public class CloudPluginConfigProviderTest {
    ...
    @Test
    public void testGetCloudS3ConfigFailure() {
        // Test that getCloudS3Config throws RuntimeException in non-cloud environment
        ...
        // Should contain expected error patterns
