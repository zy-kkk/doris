...
public class PaimonVendedCredentialsProviderTest {
    ...
    public void testExtractRawVendedCredentials() {
        ...
        Assertions.assertEquals("STS.testAccessKey123", rawCredentials.get("oss.access-key-id"));
        Assertions.assertEquals("testSecretKey456", rawCredentials.get("oss.secret-access-key"));
        Assertions.assertEquals("testSessionToken789", rawCredentials.get("oss.session-token"));
        Assertions.assertEquals("oss-cn-beijing.aliyuncs.com", rawCredentials.get("oss.endpoint"));
        Assertions.assertEquals("cn-beijing", rawCredentials.get("oss.region"));
    }
    ...
    public void testExtractRawVendedCredentialsWithPartialOSSCredentials() {
        ...
        Assertions.assertEquals("testAccessKey", rawCredentials.get("oss.access-key-id"));
        Assertions.assertEquals("testSecretKey", rawCredentials.get("oss.secret-access-key"));
        Assertions.assertFalse(rawCredentials.containsKey("oss.session-token"));
        Assertions.assertFalse(rawCredentials.containsKey("oss.endpoint"));
        Assertions.assertFalse(rawCredentials.containsKey("oss.region"));
    }
    ...
    public void testEndpointToRegionConversion() {
        ...
        for (int i = 0; i < endpoints.length; i++) {
            ...
            Assertions.assertEquals(endpoints[i], rawCredentials.get("oss.endpoint"));
            Assertions.assertEquals(expectedRegions[i], rawCredentials.get("oss.region"));
        }
    }
}
