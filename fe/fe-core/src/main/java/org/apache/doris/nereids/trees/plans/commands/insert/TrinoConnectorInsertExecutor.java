...
/**
 * Insert executor for trino connector table
 */
public class TrinoConnectorInsertExecutor extends BaseExternalTableInsertExecutor {
    private static final Logger LOG = LogManager.getLogger(TrinoConnectorInsertExecutor.class);

    /**
     * constructor
     */
    public TrinoConnectorInsertExecutor(ConnectContext ctx, TrinoConnectorExternalTable table,
    ...
    protected TransactionType transactionType() {
        return TransactionType.TRINO_CONNECTOR;
    }
